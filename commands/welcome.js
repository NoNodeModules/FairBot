...
module.exports = (client) => {
    const welcomechannelId = '839957603232120863' //Channel You Want to Send The Welcome Message
    const targetChannelId = `839957603232120863` //Channel For Rules
...
Chat In <#787083837833871404>`)
    ...
    const leavechannelId = '839957603232120863' //Channel You Want to Send The Leave Message
